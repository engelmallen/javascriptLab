...
/*function myName(name)
{
	...
	if (name=="Engel")
	...
	else 
		{
			...
			alert("does anyone knows " + name +"?")
		}
}

myName(name);*/

// 6.   Declare a function that takes no arguments but prints something to the console, 
...
//7.	Write a function that takes a number as an input from the user and checks if this number is even or odd;

var ageAsk = prompt("How old are you?")

if (ageAsk %= 1 || 3 || 5) {alert("this situation is ODD")}
